...
// top.location.href="127.0.0.1:5000";           //登录后的页面设置
// }else{alert("密码不能为空")}
// }else{alert("用户名不能为空")}})
// // 首页登录验证账号密码不能为空
...
if($(this).hasClass("kong")){
 $(".yxjc").find("img").attr("src","../static/vince/images/yadsfaxjc.png")}
if($(this).hasClass("qi")){
 $(".yxjc").find("img").attr("src","../static/vince/images/shishituxiang.jpg")}};});
// 运行监测点击效果
...
$("#hotone").click(function(){top.location.href="gczym.html";})
$("#hottwo").click(function(){top.location.href="gczym.html";})
